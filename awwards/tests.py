...
#     def setUp(self):
#         self.bihawa = Profile(user = '1', profile_photo = '', bio = 'the guy who knows a guy',contact ='bihawa@yahoo.com')

#     def test_instance(self):
#         self.assertTrue(isinstance(self.bihawa, Profile))

#     def test_save_method(self):
#         self.bihawa.save_profile()
